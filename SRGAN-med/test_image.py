#==python test_image.py --image_name test_image.jpeg==
import argparse
import time
...
# 尝试修改为epoch_2_76.pth(G为生成器,D为判别器(只在训练时使用)) ← 误把8的改到2了
#parser.add_argument('--model_name', default='netG_epoch_2_76.pth', type=str, help='generator model epoch name')
